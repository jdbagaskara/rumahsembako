                        ...
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $currency['name']; ?></td>
                                    <td class="text-center"><?php echo $currency['symbol']; ?></td>
                                    <td class="text-center"><?php echo $currency['code']; ?></td>
                                    <td class="text-center"><?php echo $currency['isCrypto']; ?></td>
                                    <td>
                                        <div class="form-switch switch-primary d-flex align-items-center justify-content-center">
                                            <input class="form-check-input" type="checkbox" role="switch" <?php echo $currency['status'] ? 'checked' : ''; ?>>
                                        </div>
                                    </td>
