...
<div class="dashboard-main-body">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Booking System</h6>
        <ul class="d-flex align-items-center gap-2">
            ...
            <li>-</li>
            <li class="fw-medium">Booking System</li>
        </ul>
    </div>
                    ...
                    <div class="shadow-7 p-24 radius-12 bg-base h-100">
                        <div class="text-center">
                            <div class="position-relative">
                                <div id="semiCircleGaugeTwo"
                                    class="big-semi-circle-gauge d-flex justify-content-center"></div>
                                <span
                                ...
                                <table class="table bordered-table table-py-8 mb-0 rounded-0 border-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-secondary-light">
                                                <div class="d-flex align-items-center gap-12">
                                                    <span class="w-40-px h-40-px radius-4 overflow-hidden">
                                                        <img src="assets/images/home-twelve/transaction-img1.png"
                                            ...
                                            <td>
                                                <span
                                                    class="bg-success-focus text-success-main px-20 py-4 radius-4 fw-medium text-sm">Completed</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-secondary-light">
                                                <div class="d-flex align-items-center gap-12">
                                                    <span class="w-40-px h-40-px radius-4 overflow-hidden">
                                                        <img src="assets/images/home-twelve/transaction-img2.png"
                                                            alt="Avatar" class="w-100 h-100 object-fit-cover">
                                                    </span>
                                            ...
                                            <td>
                                                <span
                                                    class="bg-warning-focus text-warning-main px-20 py-4 radius-4 fw-medium text-sm">Pending</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-secondary-light">
                                                <div class="d-flex align-items-center gap-12">
                                                    <span class="w-40-px h-40-px radius-4 overflow-hidden">
                                                        <img src="assets/images/home-twelve/transaction-img3.png"
                                                            alt="Avatar" class="w-100 h-100 object-fit-cover">
                                                    </span>
                                        ...
                                        <tr>
                                            <td class="text-secondary-light">
                                                <div class="d-flex align-items-center gap-12">
                                                    <span class="w-40-px h-40-px radius-4 overflow-hidden">
                                                        <img src="assets/images/home-twelve/transaction-img4.png"
                                                            alt="Avatar" class="w-100 h-100 object-fit-cover">
                                                    </span>
                                        ...
                                        <tr>
                                            <td class="text-secondary-light">
                                                <div class="d-flex align-items-center gap-12">
                                                    <span class="w-40-px h-40-px radius-4 overflow-hidden">
                                                        <img src="assets/images/home-twelve/transaction-img5.png"
                                                            alt="Avatar" class="w-100 h-100 object-fit-cover">
                                                    </span>
                            ...
                            <div class="text-center">
                                <div class="position-relative d-inline-block">
                                    <svg class="radial-progress max-w-120-px" data-percentage="70" viewBox="0 0 80 80">
                                        <circle class="incomplete stroke-8-px opacity-02 stroke-green" cx="40" cy="40"
                                            r="35">
                                        </circle>
                                    ...
                                    <span
                                        ...
                                        <i
                                            class="ri-contract-left-fill w-24-px h-24-px bg-success-600 text-md text-white d-flex justify-content-center align-items-center rounded-circle"></i>
                                    </span>
                                </div>
                                <div class="mt-24">
                                    <h5 class="mb-1">70%</h5>
                            ...
                            <div class="text-center">
                                <div class="position-relative d-inline-block">
                                    <svg class="radial-progress max-w-120-px" data-percentage="30" viewBox="0 0 80 80">
                                        <circle class="incomplete stroke-8-px opacity-02 stroke-warning" cx="40" cy="40"
                                            r="35">
                                        </circle>
                                    ...
                                    <span
                                        class="w-56-px h-56-px rounded-circle bg-neutral-200 text-warning-600 d-flex justify-content-center align-items-center position-absolute start-50 top-50 translate-middle">
                                        <i
                                            class="ri-contract-right-fill w-24-px h-24-px bg-warning-600 text-md text-white d-flex justify-content-center align-items-center rounded-circle"></i>
                                    </span>
                                </div>
                                <div class="mt-24">
                                    <h5 class="mb-1">30%</h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column gap-20">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-10">
                                    <div class="d-flex align-items-center gap-12">
                                        <span
                                            class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-blue-light-two">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-10">
                                    <div class="d-flex align-items-center gap-12">
                                        <span
                                            class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-red-light-two">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-10">
                                    <div class="d-flex align-items-center gap-12">
                                        <span
                                            class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-green-light-two">
