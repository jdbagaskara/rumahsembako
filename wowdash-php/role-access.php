                        ...
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $role['createDate']; ?></td>
                                    <td><?php echo $role['role']; ?></td>
                                    <td>
                                        <p class="max-w-500-px"><?php echo $role['description']; ?></p>
                                    </td>
                                    <td class="text-center">
                                        <span class="<?php echo $role['statusClass']; ?> px-24 py-4 radius-4 fw-medium text-sm"><?php echo $role['status']; ?></span>
                                    </td>
                                    <td class="text-center">
