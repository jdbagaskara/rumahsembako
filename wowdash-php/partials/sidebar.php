    ...
    <ul class="sidebar-menu" id="sidebar-menu">
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="index-10.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> POS & Inventory
            </a>
          </li>
          <li>
            <a href="index-11.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Finance &
              Banking </a>
          </li>
          <li>
            <a href="index-12.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Booking
              System</a>
          </li>
          <li>
            <a href="index-13.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Help Desk</a>
          </li>
          <li>
            <a href="index-14.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Podcast </a>
          </li>
          <li>
            <a href="index-15.php"><i class="ri-circle-fill circle-icon text-purple w-auto"></i> Project Management
            </a>
          </li>
          <li>
            <a href="index-16.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Call Center</a>
          </li>
          <li>
            <a href="index-17.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Sass</a>
          </li>
          <li>
            <a href="index-18.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Sales</a>
          </li>
          <li>
            <a href="index-19.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Real Estate </a>
          </li>
          <li>
            <a href="index-20.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Shipment </a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="invoice-preview.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
              Preview</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="text-generator.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Text
              Generator</a>
          </li>
          <li>
            <a href="code-generator.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Code
              Generator</a>
          </li>
          <li>
            <a href="image-generator.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Image
              Generator</a>
          </li>
          <li>
            <a href="voice-generator.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Voice
              Generator</a>
          </li>
          <li>
            <a href="video-generator.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Video
              Generator</a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="marketplace.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
              Marketplace</a>
          </li>
          <li>
            <a href="marketplace-details.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="tooltip.php"><i class="ri-circle-fill circle-icon text-lilac-600 w-auto"></i> Tooltip &
              Popover</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="form-layout.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Input
              Layout</a>
          </li>
          <li>
            <a href="form-validation.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Form
              Validation</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="table-basic.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Basic
              Table</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="column-chart.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Column
              Chart</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="view-profile.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> View
              Profile</a>
          </li>
          <li>
            <a href="users-role-permission.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> User
              Role & Permission</a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="role-access.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Role &
              Access</a>
          </li>
          <li>
            <a href="assign-role.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Assign
              Role</a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="gallery-grid.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Gallery
              Grid</a>
          </li>
          <li>
            <a href="gallery.php"><i class="ri-circle-fill circle-icon text-danger-600 w-auto"></i> Gallery Grid
              Desc</a>
          </li>
          <li>
            <a href="gallery-masonry.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Gallery
              Masonry</a>
          </li>
          <li>
            <a href="gallery-hover.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Gallery Hover
              Effect</a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="blog-details.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Blog
              Details</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="bad-request.php"><i class="ri-circle-fill circle-icon text-danger-600 w-auto"></i> Bad Request</a>
          </li>
          <li>
            <a href="forbidden.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Forbidden</a>
          </li>
          <li>
            <a href="error.php"><i class="ri-circle-fill circle-icon text-warning-600 w-auto"></i> 404 Page</a>
          </li>
          <li>
            <a href="internal-server.php"><i class="ri-circle-fill circle-icon text-primary-main w-auto"></i> Internal
              Server</a>
          </li>
          <li>
            <a href="service-unavailable.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="notification-alert.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
          ...
          <li>
            <a href="payment-gateway.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Payment
              Gateway</a>
          </li>
        </ul>
      </li>
