...
$marketplaceItems = [
    [
        ...
        'name' => 'Bitcoin',
        'symbol' => 'BTC',
        'circulatingSupply' => '0.3464 BTC',
        'price' => '$2,753.00',
        'marketCap' => '$361.32B',
        'changePercent' => '1.37%',
        'changeType' => 'success',
        'chartId' => 'timeSeriesChart1',
        'chartColor' => '#45B369'
    ],
    [
        ...
        'name' => 'Ethereum',
        'symbol' => 'ETH',
        'circulatingSupply' => '0.5464 ETH',
        'price' => '$2,753.00',
        'marketCap' => '$361.32B',
        'changePercent' => '1.37%',
        'changeType' => 'success',
        'chartId' => 'timeSeriesChart2',
        'chartColor' => '#45B369'
    ],
    [
        ...
        'name' => 'Litecoin',
        'symbol' => 'LTC',
        'circulatingSupply' => '0.5464 LTC',
        'price' => '$2,753.00',
        'marketCap' => '$361.32B',
        'changePercent' => '1.37%',
        'changeType' => 'success',
        'chartId' => 'timeSeriesChart3',
        'chartColor' => '#45B369'
    ],
    [
        ...
        'name' => 'Binance',
        'symbol' => 'BNB',
        'circulatingSupply' => '0.5464 BNB',
        'price' => '$2,753.00',
        'marketCap' => '$361.32B',
        'changePercent' => '1.37%',
        'changeType' => 'success',
        'chartId' => 'timeSeriesChart4',
        'chartColor' => '#45B369'
    ],
    [
        ...
        'name' => 'Dogecoin',
        'symbol' => 'DOGE',
        'circulatingSupply' => '0.5464 DOGE',
        'price' => '$2,753.00',
        'marketCap' => '$361.32B',
        'changePercent' => '1.37%',
        'changeType' => 'danger',
        'chartId' => 'timeSeriesChart5',
        'chartColor' => '#EF4A00'
    ],
    [
        ...
        'name' => 'Polygon ',
        'symbol' => 'MATIC',
        'circulatingSupply' => '0.5464 MATIC',
        'price' => '$2,753.00',
        'marketCap' => '$361.32B',
        'changePercent' => '1.37%',
        'changeType' => 'danger',
        'chartId' => 'timeSeriesChart6',
        'chartColor' => '#45B369'
    ],
    [
        'image' => 'crypto-img5.png',
...
foreach ($marketplaceItems as $item) {
    $script .= 'renderChart("' . $item['chartId'] . '", "' . $item['chartColor'] . '", "' . $item['chartColor'] . '");' . "\n    ";
}
$script .= '</script>';?>
                ...
                <div class="card-body p-24">
                    <div class="table-responsive scroll-sm">
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tbody>
                                <?php foreach ($marketplaceItems as $index => $item): ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-10">
                                            <div class="form-check style-check d-flex align-items-center">
                                    ...
                                    <td><?php echo $item['circulatingSupply']; ?></td>
                                    ...
                                    <td>
                                        <div id="<?php echo $item['chartId']; ?>" class="remove-tooltip-title rounded-tooltip-value"></div>
                                    </td>
