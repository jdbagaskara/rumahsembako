...
$users = [
    ...
    [
        'image' => 'user-list10.png',
        'name' => 'Cameron Williamson',
        'role' => 'Admin'
    ]
];

$roles = ['Waiter', 'Manager', 'Project Manager', 'Game Developer', 'Head', 'Management'];
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="assets/images/user-list/<?php echo $user['image']; ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" style="">
                                        ...
                                        <li><a class="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900" href="javascript:void(0)"><?php echo $role; ?></a></li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                            </td>
